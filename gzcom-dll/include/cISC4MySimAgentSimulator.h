...
public:
	...
	virtual void MoveIn(SC4String& personalName, bool isMale, cISC4MySim::ZodiacSign sign, SC4String& bio, uint32_t bitmapID, SC4String& bitmapImagePath, uint8_t slot) = 0;
