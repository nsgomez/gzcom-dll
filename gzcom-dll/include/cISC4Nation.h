...
class cISC4Nation : public cIGZUnknown
{
	public:
		...
		virtual int32_t GetRegionCount(void) const = 0;

		virtual int32_t GetActiveRegionIndex(void) const = 0;
		virtual cISC4Region* GetActiveRegion(void) const = 0;
		virtual void SetActiveRegion(cISC4Region* pRegion) = 0;
		...
		virtual void DeleteRegion(uint32_t dwIndex) = 0;
