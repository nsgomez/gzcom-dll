...
class cISC4DBSegmentOStream : public cIGZOStream
{
	public:
		...
		virtual int64_t WriteGZSerializable(cIGZSerializable const* pSegment) = 0;
		virtual int64_t WriteResKey(cGZPersistResourceKey const& sKey) = 0;
		virtual int32_t WriteVariant(cIGZVariant const& sVariant) = 0;
};